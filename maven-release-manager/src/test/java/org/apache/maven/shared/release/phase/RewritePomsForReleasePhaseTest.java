 ...
 */
public class RewritePomsForReleasePhaseTest extends AbstractEditModeRewritingReleasePhaseTestCase {
    ...
    @Test
    public void testRewritePomWithExternallyReleasedParent() throws Exception {
