...
/**
 * Based on DefaultArtifactVersionTest
 *
 */
public class MavenArtifactVersionTest
{
    private ArtifactVersion newArtifactVersion( String version ) throws VersionParseException
    {
        return new MavenArtifactVersion( version );
    }

    private void checkVersionParsing( String version, int major, int minor, int incremental, int buildnumber,
                                      String qualifier ) throws VersionParseException
    {
    ...
    @Test
    public void testVersionComparing() throws Exception
    {
    ...
    @Test
    public void testVersionSnapshotComparing() throws Exception
    {
    ...
    @Test
    public void testSnapshotVsReleases() throws Exception
    {
    ...
    @Test
    public void testEqualsNullSafe() throws Exception
    {
        assertFalse( newArtifactVersion( "1" ).equals( null ) );
    }

    @Test
    public void testEqualsTypeSafe() throws Exception
    {
        assertFalse( newArtifactVersion( "1" ).equals( "non-an-artifact-version-instance" ) );
    }

    private void assertVersionOlder( String left, String right ) throws Exception
    {
    ...
    private void assertVersionEqual( String left, String right ) throws Exception
    {
